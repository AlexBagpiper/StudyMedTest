...
6.  В списке тестов нажмите на иконку **«Опубликовать»**, чтобы тест стал доступен студентам.
...
*   **Графические задания**:
    ...
    *   Для каждой созданной области **обязательно** выберите категорию в выпадающем меню.
*   Для перехода между вопросами используйте кнопки **«Назад»** и **«Далее»**.

### 4.3. Завершение
На последнем вопросе нажмите кнопку **«Завершить тест»**. Система отправит ваши ответы на сервер для автоматической оценки. Это может занять до 10-30 секунд.
