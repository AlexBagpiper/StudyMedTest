...
const translations = {
  ru: {
    ...
    'questions.allowPartial': 'Разрешить частичное выделение контура (для сложных контуров)',
    'questions.cvConfigTitle': 'Индивидуальные настройки CV-оценки',
    'questions.useCustomCvConfig': 'Использовать индивидуальные параметры для этого вопроса',
    'questions.iouWeight': 'Вес геометрии (IoU)',
    'questions.iouWeightDesc': 'Влияние точности совпадения контуров на итоговый балл.',
    'questions.recallWeight': 'Вес полноты (Recall)',
    'questions.recallWeightDesc': 'Влияние доли найденных объектов на итоговый балл.',
    'questions.precisionWeight': 'Вес точности (Precision)',
    'questions.precisionWeightDesc': 'Влияние отсутствия лишних (ошибочных) аннотаций на итоговый балл.',
    'questions.iouThreshold': 'Порог для зачета обьекта (IoU)',
    'questions.iouThresholdDesc': 'Минимальное пересечение с эталоном, при котором объект считается найденным верно.',
    'questions.inclusionThreshold': 'Порог включения (Inclusion)',
    'questions.inclusionThresholdDesc': 'Доля ответа студента, которая должна находиться внутри эталона (для частичного зачета).',
    'questions.coverageThreshold': 'Порог выделения (Coverage)',
    'questions.coverageThresholdDesc': 'Минимальная площадь эталона, которую должен выделить студент (защита от случайных точек).',
  ...
  en: {
    ...
    'questions.cvConfigTitle': 'Individual CV Scoring Settings',
    'questions.useCustomCvConfig': 'Use individual parameters for this question',
    'questions.iouWeight': 'IoU Weight (geometry)',
    'questions.iouWeightDesc': 'Influence of contour match accuracy on the final score.',
    'questions.recallWeight': 'Recall Weight (completeness)',
    'questions.recallWeightDesc': 'Influence of the proportion of found objects on the final score.',
    'questions.precisionWeight': 'Precision Weight (accuracy)',
    'questions.precisionWeightDesc': 'Influence of the absence of extra (erroneous) annotations on the final score.',
    'questions.iouThreshold': 'IoU Threshold',
    'questions.iouThresholdDesc': 'Minimum intersection with the reference at which an object is considered correctly found.',
    'questions.inclusionThreshold': 'Inclusion Threshold',
    'questions.inclusionThresholdDesc': 'Proportion of the student\'s answer that must be inside the reference (for partial credit).',
    'questions.coverageThreshold': 'Coverage Threshold',
    'questions.coverageThresholdDesc': 'Minimum area of the reference that the student must highlight (protection against accidental points).',
